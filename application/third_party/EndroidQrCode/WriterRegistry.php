...
require_once(APPPATH.'third_party/EndroidQrCode/Exception/InvalidWriterException.php');
require_once(APPPATH.'third_party/EndroidQrCode/Writer/AbstractWriter.php');
require_once(APPPATH.'third_party/EndroidQrCode/Writer/BinaryWriter.php');
require_once(APPPATH.'third_party/EndroidQrCode/Writer/DebugWriter.php');
require_once(APPPATH.'third_party/EndroidQrCode/Writer/EpsWriter.php');
require_once(APPPATH.'third_party/EndroidQrCode/Writer/PngWriter.php');
require_once(APPPATH.'third_party/EndroidQrCode/Writer/SvgWriter.php');
require_once(APPPATH.'third_party/EndroidQrCode/WriterRegistryInterface.php');
...
class WriterRegistry implements WriterRegistryInterface
{
    ...
    public function loadDefaultWriters(): void
    {
        ...
        $this->addWriters([
            new Writer\BinaryWriter(),
            new Writer\DebugWriter(),
            new Writer\EpsWriter(),
            new Writer\PngWriter(),
            new Writer\SvgWriter(),
        ]);
