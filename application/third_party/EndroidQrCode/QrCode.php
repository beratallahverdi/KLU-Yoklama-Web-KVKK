...
require_once(APPPATH.'third_party/EndroidQrCode/LabelAlignment.php');
require_once(APPPATH.'third_party/EndroidQrCode/ErrorCorrectionLevel.php');
require_once(APPPATH.'third_party/EndroidQrCode/WriterRegistry.php');
...
require_once(APPPATH.'third_party/EndroidQrCode/Exception/InvalidPathException.php');
require_once(APPPATH.'third_party/EndroidQrCode/Exception/UnsupportedExtensionException.php');
