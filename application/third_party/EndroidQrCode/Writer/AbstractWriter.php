...
require_once(APPPATH.'third_party/EndroidQrCode/Exception/InvalidLogoException.php');
require_once(APPPATH.'third_party/EndroidQrCode/Exception/MissingExtensionException.php');
