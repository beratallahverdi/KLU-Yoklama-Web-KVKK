...
require_once(APPPATH.'third_party/EndroidQrCode/Exception/GenerateImageException.php');
require_once(APPPATH.'third_party/EndroidQrCode/Exception/MissingFunctionException.php');
require_once(APPPATH.'third_party/EndroidQrCode/Exception/MissingLogoHeightException.php');
require_once(APPPATH.'third_party/EndroidQrCode/Exception/ValidationException.php');
